  ...
  return (
    <div className="p-3 border-2 rounded-xl border-indigo-500 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105 duration-300 ...">
      <div className="px-6 py-4">
        <NextLink href={details.website} passHref className="text-xl font-semibold hover:text-blue-400 hover:underline">
            <Image
              src={jobSvg}
              width={20}
              height={20}
      ...
      <NextLink href={details.website} passHref className="btn bg-green-500 hover:bg-green-700" target="_blank">
        Apply
      </NextLink>
    </div>
  );
